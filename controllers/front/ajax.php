...
if (!class_exists('MpSendToAFriend')) {
    include_once _PS_MODULE_DIR_.'mpsendtoafriend/mpsendtoafriend.php';
}

/**
 * Class MpSendtoAfriendajaxModuleFrontController
 */
class MpSendtoAfriendajaxModuleFrontController extends ModuleFrontController
{
    /**
     * Initialize content
     */
